...
// Member `data`
#include "custom_interfaces/msg/detail/string_float_tuple__functions.h"
...
custom_interfaces__msg__PoseList__init(custom_interfaces__msg__PoseList * msg)
{
  ...
  // data
  if (!custom_interfaces__msg__StringFloatTuple__Sequence__init(&msg->data, 0)) {
...
custom_interfaces__msg__PoseList__fini(custom_interfaces__msg__PoseList * msg)
{
  ...
  // data
  custom_interfaces__msg__StringFloatTuple__Sequence__fini(&msg->data);
}
...
custom_interfaces__msg__PoseList__are_equal(const custom_interfaces__msg__PoseList * lhs, const custom_interfaces__msg__PoseList * rhs)
{
  ...
  // data
  if (!custom_interfaces__msg__StringFloatTuple__Sequence__are_equal(
      &(lhs->data), &(rhs->data)))
  {
    return false;
  }
  ...
  custom_interfaces__msg__PoseList * output)
{
  ...
  // data
  if (!custom_interfaces__msg__StringFloatTuple__Sequence__copy(
