...
// Member 'data'
#include "custom_interfaces/msg/detail/string_float_tuple__struct.hpp"
...
struct PoseList_
{
  ...
  using _data_type =
    std::vector<custom_interfaces::msg::StringFloatTuple_<ContainerAllocator>, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<custom_interfaces::msg::StringFloatTuple_<ContainerAllocator>>>;
  _data_type data;

  // setters for named parameter idiom
  Type & set__data(
    const std::vector<custom_interfaces::msg::StringFloatTuple_<ContainerAllocator>, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<custom_interfaces::msg::StringFloatTuple_<ContainerAllocator>>> & _arg)
  {
    this->data = _arg;
    return *this;
  }
