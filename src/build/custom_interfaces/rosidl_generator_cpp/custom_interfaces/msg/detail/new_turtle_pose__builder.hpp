...
class Init_NewTurtlePose_z
{
public:
  explicit Init_NewTurtlePose_z(::custom_interfaces::msg::NewTurtlePose & msg)
  : msg_(msg)
  {}
  ::custom_interfaces::msg::NewTurtlePose z(::custom_interfaces::msg::NewTurtlePose::_z_type arg)
  {
    msg_.z = std::move(arg);
...
public:
  ...
  : msg_(msg)
  {}
  Init_NewTurtlePose_z y(::custom_interfaces::msg::NewTurtlePose::_y_type arg)
  {
    msg_.y = std::move(arg);
    return Init_NewTurtlePose_z(msg_);
  }
