...
{
  const auto * member = reinterpret_cast<const std::vector<custom_interfaces::msg::NewTurtlePose> *>(untyped_member);
  return member->size();
}
...
{
  const auto & member =
    *reinterpret_cast<const std::vector<custom_interfaces::msg::NewTurtlePose> *>(untyped_member);
  return &member[index];
}
...
{
  auto & member =
    *reinterpret_cast<std::vector<custom_interfaces::msg::NewTurtlePose> *>(untyped_member);
  return &member[index];
}
...
{
  const auto & item = *reinterpret_cast<const custom_interfaces::msg::NewTurtlePose *>(
    get_const_function__PoseList__data(untyped_member, index));
  auto & value = *reinterpret_cast<custom_interfaces::msg::NewTurtlePose *>(untyped_value);
  value = item;
}
...
{
  auto & item = *reinterpret_cast<custom_interfaces::msg::NewTurtlePose *>(
    get_function__PoseList__data(untyped_member, index));
  const auto & value = *reinterpret_cast<const custom_interfaces::msg::NewTurtlePose *>(untyped_value);
  item = value;
}
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember PoseList_message_member_array[1] = {
  {
    ...
    ::rosidl_typesupport_introspection_cpp::get_message_type_support_handle<custom_interfaces::msg::NewTurtlePose>(),  // members of sub message
    true,  // is array
    0,  // array size
